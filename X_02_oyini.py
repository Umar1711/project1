...
def qator_yo_ustun(text):
    #  kiritishni tekshirish
    while True:
        qator_yo_ustun = input(f" {text} raqamini kiriting (0-2): ")
        if qator_yo_ustun == "0" or qator_yo_ustun == "1" or qator_yo_ustun == "2":
            qator_yo_ustun = int(qator_yo_ustun)
            break
        else:
            print("X notogri qator! 0 , 1 yoki 2 kiriting. ")
    return qator_yo_ustun
